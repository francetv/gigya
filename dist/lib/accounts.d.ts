...
export declare type AccountsSchemaWriteAccess = 'serverOnly' | 'clientCreate' | 'clientModify';
export declare type AccountsSchemaType = 'integer' | 'long' | 'float' | 'basic-string' | 'string' | 'text' | 'date' | 'boolean';
export declare type AccountsSchemaEncrypt = 'AES' | '';
